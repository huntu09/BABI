-- Create user_badges table (CRITICAL - Badge system won't work without this)
...
-- Add missing created_at to notifications table
...
COMMENT ON COLUMN user_badges.progress IS 'Progress towards badge completion (0-100)';
