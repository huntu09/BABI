-- =====================================================
-- MISSING OFFERWALL TABLES (FIXED VERSION)
-- Melengkapi sistem offerwall dengan cached_offers dan offer_clicks
-- Fixed RLS policies untuk profiles.is_admin
-- =====================================================
...
(
    'cpx_research', 'CPX_004', 'Complete Product Review Survey',
    'Review products you have used and earn points', 3.75, 3.75,
    'survey', 'https://cpx-research.com/offer/CPX_004',
    '/placeholder.svg?height=100&width=100',
    ARRAY['ID', 'MY', 'SG', 'TH'], ARRAY['mobile', 'desktop'],
    '15 minutes', 'medium'
);
...
(
    ...
    '/placeholder.svg?height=100&width=100',
    ARRAY['US', 'CA', 'GB', 'ID'], ARRAY['mobile', 'desktop'],
    '1 minute', 'easy'
),
(
    ...
    '/placeholder.svg?height=100&width=100',
    ARRAY['US', 'CA', 'ID'], ARRAY['desktop'],
    '15 minutes', 'medium'
);

-- Insert sample Indonesian-focused offers
INSERT INTO cached_offers (
    provider, external_offer_id, title, description, reward_amount, original_reward,
    category, offer_url, image_url, countries, devices, estimated_time, difficulty, is_featured
) VALUES 
(
    'cpx_research', 'CPX_ID_001', 'Survey Kebiasaan Belanja Online Indonesia',
    'Bagikan pengalaman belanja online Anda di Indonesia', 4.00, 4.00,
    'survey', 'https://cpx-research.com/offer/CPX_ID_001',
    '/placeholder.svg?height=100&width=100',
    ARRAY['ID'], ARRAY['mobile', 'desktop'],
    '12 minutes', 'easy', true
),
(
    'lootably', 'LOOT_ID_001', 'Download Aplikasi E-Commerce Terpopuler',
    'Download dan daftar di aplikasi e-commerce Indonesia', 6.50, 6.50,
    'app_install', 'https://lootably.com/offer/LOOT_ID_001',
    '/placeholder.svg?height=100&width=100',
    ARRAY['ID'], ARRAY['mobile'],
    '20 minutes', 'medium', true
);
...
BEGIN
    ...
    RAISE NOTICE '🇮🇩 Indonesian offers included for local market!';
END $$;
